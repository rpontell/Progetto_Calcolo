...
Infine per ciascun $n$ dell'algoritmo più efficiente, si testa l'interpolante costruita su tali nodi con la funzione:
\[
f(x)=\frac{1}{x-1.3},
\]
ben definita su \([{-}1,1]\).
...
\end{figure}
A parità di condizioni, si nota come l'algoritmo DLP sia più veloce rispetto a DLP2. Questa differenza è dovuta alle operazioni di 
